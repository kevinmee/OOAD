/****
 ************************************************************
 * This files was developed for CS4233: Object
 -
 Oriented Analysis &
 Design.
...
/**
 * Exception that is only thrown when a player resigns while there is still a
 * valid move available for that player.
 *
 * @version Oct 6, 2014
 */
